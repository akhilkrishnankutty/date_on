...
public class UserController {
    ...
    public ResponseEntity<?> getUser(
        ...
        if ("MATCHED".equals(currentUser.getStatus()) && currentUser.getLoid() == user.getId()) {
            ...
            // Security: Prevent IDOR by returning a generic placeholder if match is < 5 days old. Fail closed.
            if (user.getMatchTime() != null && java.time.temporal.ChronoUnit.DAYS.between(user.getMatchTime(), java.time.LocalDateTime.now()) >= 5) {
                ...
                safeUser.setProfilePictureUrl("https://res.cloudinary.com/dquj7szs3/image/upload/v1/placeholder/blurred_avatar.png");
            }
